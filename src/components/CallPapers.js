                    ...
                    <div className=" border-gray-300  bg-white rounded-xl w-[70rem] py-2 pt-10 px-5">
                        <div className="grid grid-cols-6 gap-3 bg-white">
                            ...
                            <div className="col-span-2 flex justify-center align-middle">
                                ...
                                <Lottie animationData={animation} loop="1" className="" style={{ width: "70%", height: "70%" }} />;

                            </div>


                            <div className="col-span-4">
                                <p className="sm:text-xl text-black font-bold font-ourFont lg:text-3xl uppercase animate-bounce "> <span className=" underline">Important Dates !</span></p>
                                <p className="text-gray-800 my-2 font-bold lg:text-lg">
                                    <span className='underline'>Paper Submission</span>: September 25th, 2022
                                    <br /><br />
                                    <span className='underline'>Notification of Acceptance:</span> September 4th, 2022
                                    <br /><br />
                                    <span className='underline'>Camera Ready:</span> November 8th, 2022
                                </p>
                            </div>
