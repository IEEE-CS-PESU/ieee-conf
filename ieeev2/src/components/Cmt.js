...
const Cmt = () => {
    ...
    return (
        <div className=" w-full bg-gray-100" style={bgStyles}>
            <div id="committee" style={responseStyles} className="w-5/6 py-4 px-8 bg-white shadow-lg
                ...
                <div >
                    ...
                    <div className=" grid justify-items-stretch mt-2 text-gray-600 text-center">
                        <div className="grid grid-cols-1 lg:grid-cols-2" >
                            <div>
                                {name.map((item, key) => {
                                    return <li key={key} className="text-sm md:text-lg lg:text-lg text-left">{item} </li>
                                })}
