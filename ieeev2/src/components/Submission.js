        ...
        <div className="submit bg-gray-100/60 h-max">
            ...
            <div className="content  w-full px-14">
                ...
                <p>
                    ...
                    All papers accepted for publication must follow the formatting rules for Springer Proceedings (https://www.iospress.com/book-article-instructions) and be written in English, with a length of at least 6 but no more than 10 pages. Latex and Word templates can be found in http://www<br />.iospress.nl/service/authors/latex-and-word-tools-for-book-authors.
                    <br /><br />
                    Important note for double blind review policy: The version of papers for evaluation by the Program Committee, saved in PDF format, must not include identification, e-mail, affiliation of the authors, grants, funding institution or any explicit information, that may disclose the authors’ identity (this information <br /><br />s to be restored in the camera-ready version upon acceptance). Please remove author names and affiliations (or replace it with Xs) on submitted papers. In particular, in the version submitted for review please avoid explicit auto-references, such as “as we shown in [1]” — consider “as shown in [1]“. i.e., you may cite your own previous works p<br /><br />rovided that it is not deducible from the text that the cited work belongs to the authors. This information must only be available in the camera-ready version of accepted papers, saved in Word or Latex format and also in PDF format. These files must be accompanied by the Consent to Publish form filled out, in a ZIP file, and uploaded at the conference management system.

                    The submission system for this workshop is based on EasyChair. To submit or upload a pa<br /><br />per please go to https://easychair.org/conferences/?conf=sentirobots2022.

                    All papers accepted in the Workshops program will be published as a volume of the Ambient Intelligence and Smart Environments Ser<br /><br />ies of IOS Press and electronically available through ACM Digital Library (pending approval). The proceedings will be ISI indexed
                </p>
                <br />

                <a target='blank' href="https://easychair.org/account/signin?l=sYEPpdPXZTcyjrogSzhcpW">
